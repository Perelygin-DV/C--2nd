...
namespace Ex121
{
    class HeroIntelligence
    {
        ...
        public HeroIntelligence() :
            this($"Hero #{++HeroIntelligence.number}",
                HeroIntelligence.r.Next(100, 200),
                HeroIntelligence.r.Next(150, 250)
                )
        {
        ...
        public int Attack()
        {
            return HeroIntelligence.r.Next(10, 20);
        }
        ...
        public int Healing()
        {
            if (this.mp - this.casting >= 0)
            {
                this.mp -= this.casting;
                return HeroIntelligence.r.Next(10, 20);
            }
            else { return 0; }
        }
